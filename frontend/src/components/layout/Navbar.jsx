  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "glass shadow-sm border-b border-ink-100/80 dark:border-ink-800/80"
          : "bg-transparent"
      }`}
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-2">
            ...
            <form onSubmit={handleSearch} className="flex items-center">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-9 pr-4 py-2 text-sm bg-ink-100 dark:bg-ink-800 border-0 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-400 w-44 focus:w-56 transition-all duration-300 text-ink-900 dark:text-white placeholder-ink-400"
                />
              </div>
            </form>
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-xl text-ink-700 dark:text-white hover:bg-ink-100 dark:hover:bg-ink-800 hover:text-ink-900 dark:hover:text-white transition-all duration-200"
            ...
            <Link
              to="/bookmarks"
              className="p-2 rounded-xl text-ink-700 dark:text-white hover:bg-ink-100 dark:hover:bg-ink-800 hover:text-brand-500 transition-all duration-200"
            ...
            {token ? (
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  ...
                  <span className="hidden sm:block text-sm font-medium text-ink-700 dark:text-white max-w-20 truncate">
                    {user?.name?.split(" ")[0]}
                  </span>
                </button>
